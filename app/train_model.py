...
def main():
    """Entry point into the training script.
    """
    start_time = time.perf_counter()

    # Step 0 - Define hyperparameters. These parameters can be modified
    ...
    print('\tMax training iterations: {}'.
          format(Hyperparams.max_training_iters))
    ...
    # Step 2 - Create a tokenizer to decompose strings into
    # character-level integer arrays
    ...
    # Step 6 - Save the model parameters so they can be loaded in the 
    # future without retraining the model
    output_dir = 'output/'
